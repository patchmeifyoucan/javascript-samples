...
function makeAgeFilter(lower, upper) {
  if (!upper) {
    return function (p, i, a) {
      return p.age < lower;
    }
  }

  return function (p) {
    return p.age > lower && p.age < upper;
  }
}

var f1 = makeAgeFilter(20);
var younger20 = people.filter(f1);

var younger30 = people.filter(makeAgeFilter(30));
//
console.log('younger20', JSON.stringify(younger20));
console.log('younger30', JSON.stringify(younger30));

var between20and50 = people.filter(makeAgeFilter(20, 50));

...
var sum = under30.reduce(function (previous, current) {
  return current + previous
}, 0)

var avg = sum / under30.length

var avgES6 = under30.reduce((current, result) => result + current, 0) / under30.length

console.log('ages       ', JSON.stringify(under30))
console.log('average    ', avg)
console.log('averageES6 ', avgES6)
